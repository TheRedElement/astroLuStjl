...
#TODO: examples similar to python (plot grid of defined apertures)
...
#%%general way of constructing apertures
#pseudo data
...
#%%general way of plotting apertures
...
#%%examples for different settings (standard aperture)
...
#%%examples for different settings (sky-ring)
apt = ApertureShapes.ApertureTemplate(50, 60, 0, 0; npixels=1, outside=0)  #aperture generator
